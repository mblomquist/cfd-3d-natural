...
subroutine output3d_results
  ...
  write(2, *), 'ZONE I=15, J=15, K=7, DATAPACKING=POINT'
  ...
  write (5, *), "R_e, R_t, R_u, R_v, R_w, t_1, t_2, t_3, t_4, t_5, t_6, t_7"
  do i = 1, itrmax
    write (5,'(E12.5, ",", E12.5, ",", E12.5, ",", E12.5, ",", E12.5, ",", E12.5, ",", E12.5, ",", E12.5, ",", E12.5, ",", E12.5)', advance="no"), &
               R_e(i,1), R_t(i,1), R_u(i,1), R_v(i,1), R_w(i,1), t_1(i), t_2(i), t_3(i), t_4(i), t_5(i), t_6(i), t_7(i)
  end do
